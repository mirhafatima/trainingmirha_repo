...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        watch: {
            ...
            doc: {
                files: ['doc/js/**/*', '!doc/dist/', '!doc/.tmp', 'app_vw_core/**/*.{js,ds}', 'app_vw_controllers/**/*.{js,ds}'],
                tasks: ['jsdoc']
            },
            server: {
                files: [
                    'app_vw_controllers/cartridge/**/*.{js,json,properties}',
                    'app_vw_core/cartridge/**/*.{isml,json,properties,xml}',
                    'app_vw_core/cartridge/scripts/**/*.{js,ds}',
                    'app_vw_core/cartridge/static/**/*.{js,css,png,gif}',
                    'app_vw_pipelines/cartridge/**/*.{properties,xml}'
                ],
                tasks: ['dwDavUpload'],
                options: {
                    spawn: false
        ...
        dwDavUpload: {
            ...
            src: 'app_vw_controllers/cartridge/cartridge/controllers/Product.js'
        },
        concurrent: {
            options: {
